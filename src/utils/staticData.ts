...
export const BookingStepsTexts = {
  ...
  cardOne: {
    ...
    imageSrc: '/bookingImage1.jpeg',
  },
  cardTwo: {
    status: 'Ongoing',
    destination: 'Trip to Rome',
    completion: '40% Completed',
    imageSrc: '/bookingImage2.jpeg',
  },
};
